...
<img src="D:\算法Typora\picture\Sort-冒泡排序.gif" style="zoom: 80%;" />
...
<img src="D:\算法Typora\picture\Sort-选择排序.gif" style="zoom: 80%;" />
...
<img src="D:\算法Typora\picture\Sort-堆排序.jpg" style="zoom:67%;" />
...
<img src="D:\算法Typora\picture\Sort-插入排序.png" style="zoom: 67%;" />
...
<img src="D:\算法Typora\picture\Sort-希尔排序.png" style="zoom:67%;" />
...
<img src="D:\算法Typora\picture\Sort-归并排序.png" style="zoom:50%;" />

归并步骤：每次比较两端最小的值，把最小的值放在辅助数组的左边

![](D:\算法Typora\picture\Sort-归并步骤1.png)

![](D:\算法Typora\picture\Sort-归并步骤2.png)

![](D:\算法Typora\picture\Sort-归并步骤3.png)
...
<img src="D:\算法Typora\picture\Sort-归并排序时间复杂度.png" style="zoom: 67%;" />
...
<img src="D:\算法Typora\picture\Sort-快速排序.gif" style="zoom:80%;" />
...
* 最坏情况：每一次切分选择的基准数字是当前序列中最大数或者最小数，这使得每次切分都会有一个子组，那么总共就得切分n次，所以最坏情况下，快速排序的时间复杂度为 O(n^2)
  ...
  <img src="D:\算法Typora\picture\Sort-快排时间复杂度.png" style="zoom: 50%;" />
...
<img src="D:\算法Typora\picture\Sort-基数排序.gif" style="zoom:67%;" />
...
<img src="D:\算法Typora\picture\Sort-稳定性.png" style="zoom:50%;" />
...
![](D:\算法Typora\picture\Sort-排序算法对比.png)
...
<img src="D:\算法Typora\picture\二叉树结构图.png" alt="二叉树结构图" style="zoom:80%;" />
...
<img src="D:\算法Typora\picture\二叉查找树结构图.png" alt="二叉查找树" style="zoom: 80%;" />
...
* 删除节点：要删除节点12，先找到节点19，然后移动并替换节点12<img src="D:\算法Typora\picture\Tree-二叉查找树删除节点.png" style="zoom: 50%;" />
...
![平衡二叉树和二叉查找树对比](D:\算法Typora\picture\平衡二叉树和二叉查找树对比结构图.png)

+ 左旋：将根节点的右侧往左拉，原先的右子节点变成新的父节点，并把多余的左子节点出让，给已经降级的根节点当右子节点

  ![平衡二叉树左旋](D:\算法Typora\picture\平衡二叉树左旋01.png)

* 右旋：将根节点的左侧往右拉，左子节点变成了新的父节点，并把多余的右子节点出让，给已经降级根节点当左子节点

  ![平衡二叉树右旋](D:\算法Typora\picture\平衡二叉树右旋01.png)
...
![红黑树](D:\算法Typora\picture\红黑树结构图.png)



红黑树添加节点的默认颜色为红色，效率高
![](D:\算法Typora\picture\红黑树添加节点颜色.png)
...
<img src="D:\算法Typora\picture\Tree-并查集.png" style="zoom:50%;" />
...
<img src="D:\算法Typora\picture\Tree-并查集存储结构.png" style="zoom:67%;" />

合并方式：

<img src="D:\算法Typora\picture\Tree-并查集合并.png" style="zoom:67%;" />
...
<img src="D:\算法Typora\picture\Tree-并查集优化.png" style="zoom: 67%;" />
...
<img src="D:\算法Typora\picture\Tree-并查集时间复杂度.png" style="zoom:67%;" />
...
<img src="D:\算法Typora\picture\Tree-应用场景.png" style="zoom:67%;" />
...
<img src="D:\算法Typora\picture\Tree-字典树构造过程1.png" style="zoom: 50%;" />

<img src="D:\算法Typora\picture\Tree-字典树构造过程2.png" style="zoom:50%;" />
...
<img src="D:\算法Typora\picture\Tree-字典树存储结构.png" style="zoom:50%;" />
...
![](D:\算法Typora\picture\Tree-字典树缩点优化.png)
...
<img src="D:\算法Typora\picture\Redis-Bitmaps数据结构.png" style="zoom: 80%;" />
...
![](D:\算法Typora\picture\Redis-布隆过滤器添加数据.png)
